.class public final Lccsanokhttp3/internal/publicsuffix/PublicSuffixDatabase;
...
.field private static final instance:Lccsanokhttp3/internal/publicsuffix/PublicSuffixDatabase;
...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lccsanokhttp3/internal/publicsuffix/PublicSuffixDatabase;->WILDCARD_LABEL:[B

    .line 39
    new-array v1, v3, [Ljava/lang/String;

    sput-object v1, Lccsanokhttp3/internal/publicsuffix/PublicSuffixDatabase;->EMPTY_RULE:[Ljava/lang/String;
    ...
    sput-object v0, Lccsanokhttp3/internal/publicsuffix/PublicSuffixDatabase;->PREVAILING_RULE:[Ljava/lang/String;

    .line 44
    new-instance v0, Lccsanokhttp3/internal/publicsuffix/PublicSuffixDatabase;

    invoke-direct {v0}, Lccsanokhttp3/internal/publicsuffix/PublicSuffixDatabase;-><init>()V

    sput-object v0, Lccsanokhttp3/internal/publicsuffix/PublicSuffixDatabase;->instance:Lccsanokhttp3/internal/publicsuffix/PublicSuffixDatabase;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lccsanokhttp3/internal/publicsuffix/PublicSuffixDatabase;->listRead:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput-object v0, p0, Lccsanokhttp3/internal/publicsuffix/PublicSuffixDatabase;->readCompleteLatch:Ljava/util/concurrent/CountDownLatch;
...
.method private findMatchingRule([Ljava/lang/String;)[Ljava/lang/String;
    ...
    .line 110
    iget-object v0, p0, Lccsanokhttp3/internal/publicsuffix/PublicSuffixDatabase;->listRead:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    .line 111
    invoke-direct {p0}, Lccsanokhttp3/internal/publicsuffix/PublicSuffixDatabase;->readTheListUninterruptibly()V
    ...
    :cond_0
    :try_start_0
    iget-object v0, p0, Lccsanokhttp3/internal/publicsuffix/PublicSuffixDatabase;->readCompleteLatch:Ljava/util/concurrent/CountDownLatch;
    ...
    .line 121
    :try_start_1
    iget-object v0, p0, Lccsanokhttp3/internal/publicsuffix/PublicSuffixDatabase;->publicSuffixListBytes:[B
    ...
    .line 137
    iget-object v4, p0, Lccsanokhttp3/internal/publicsuffix/PublicSuffixDatabase;->publicSuffixListBytes:[B

    invoke-static {v4, v0, v3}, Lccsanokhttp3/internal/publicsuffix/PublicSuffixDatabase;->binarySearchBytes([B[[BI)Ljava/lang/String;
    ...
    .line 153
    sget-object v6, Lccsanokhttp3/internal/publicsuffix/PublicSuffixDatabase;->WILDCARD_LABEL:[B

    aput-object v6, v4, v5

    .line 154
    iget-object v6, p0, Lccsanokhttp3/internal/publicsuffix/PublicSuffixDatabase;->publicSuffixListBytes:[B

    invoke-static {v6, v4, v5}, Lccsanokhttp3/internal/publicsuffix/PublicSuffixDatabase;->binarySearchBytes([B[[BI)Ljava/lang/String;
    ...
    .line 166
    iget-object v6, p0, Lccsanokhttp3/internal/publicsuffix/PublicSuffixDatabase;->publicSuffixExceptionListBytes:[B

    invoke-static {v6, v0, v5}, Lccsanokhttp3/internal/publicsuffix/PublicSuffixDatabase;->binarySearchBytes([B[[BI)Ljava/lang/String;
    ...
    .line 180
    sget-object v1, Lccsanokhttp3/internal/publicsuffix/PublicSuffixDatabase;->PREVAILING_RULE:[Ljava/lang/String;
    ...
    .line 185
    :cond_a
    sget-object v1, Lccsanokhttp3/internal/publicsuffix/PublicSuffixDatabase;->EMPTY_RULE:[Ljava/lang/String;
    ...
    .line 189
    :cond_b
    sget-object v5, Lccsanokhttp3/internal/publicsuffix/PublicSuffixDatabase;->EMPTY_RULE:[Ljava/lang/String;
...
.method public static get()Lccsanokhttp3/internal/publicsuffix/PublicSuffixDatabase;
    .locals 1

    .line 60
    sget-object v0, Lccsanokhttp3/internal/publicsuffix/PublicSuffixDatabase;->instance:Lccsanokhttp3/internal/publicsuffix/PublicSuffixDatabase;
...
.method private readTheList()V
    ...
    .line 312
    const-class v0, Lccsanokhttp3/internal/publicsuffix/PublicSuffixDatabase;
    ...
    .line 315
    :cond_0
    new-instance v1, Lccsanokio/GzipSource;

    invoke-static {v0}, Lccsanokio/Okio;->source(Ljava/io/InputStream;)Lccsanokio/Source;

    move-result-object v2

    invoke-direct {v1, v2}, Lccsanokio/GzipSource;-><init>(Lccsanokio/Source;)V
    ...
    .line 316
    .local v1, "bufferedSource":Lccsanokio/BufferedSource;
    :try_start_0
    ...
    invoke-interface {v1, v3}, Lccsanokio/BufferedSource;->readFully([B)V
    ...
    invoke-interface {v1, v5}, Lccsanokio/BufferedSource;->readFully([B)V
    :try_end_0
    ...
    invoke-interface {v1}, Lccsanokio/BufferedSource;->close()V

    .line 325
    .end local v1    # "bufferedSource":Lccsanokio/BufferedSource;
    :cond_1
    monitor-enter p0

    .line 326
    :try_start_1
    iput-object v3, p0, Lccsanokhttp3/internal/publicsuffix/PublicSuffixDatabase;->publicSuffixListBytes:[B

    .line 327
    iput-object v5, p0, Lccsanokhttp3/internal/publicsuffix/PublicSuffixDatabase;->publicSuffixExceptionListBytes:[B
    ...
    .line 330
    iget-object v1, p0, Lccsanokhttp3/internal/publicsuffix/PublicSuffixDatabase;->readCompleteLatch:Ljava/util/concurrent/CountDownLatch;
    ...
    .restart local v1    # "bufferedSource":Lccsanokio/BufferedSource;
    :catchall_1
    move-exception v2
...
.method private readTheListUninterruptibly()V
    ...
    :goto_0
    :try_start_0
    invoke-direct {p0}, Lccsanokhttp3/internal/publicsuffix/PublicSuffixDatabase;->readTheList()V
    :try_end_0
...
.method public getEffectiveTldPlusOne(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p0, v2}, Lccsanokhttp3/internal/publicsuffix/PublicSuffixDatabase;->findMatchingRule([Ljava/lang/String;)[Ljava/lang/String;
...
.method setListBytes([B[B)V
    ...
    .line 335
    iput-object p1, p0, Lccsanokhttp3/internal/publicsuffix/PublicSuffixDatabase;->publicSuffixListBytes:[B

    .line 336
    iput-object p2, p0, Lccsanokhttp3/internal/publicsuffix/PublicSuffixDatabase;->publicSuffixExceptionListBytes:[B
