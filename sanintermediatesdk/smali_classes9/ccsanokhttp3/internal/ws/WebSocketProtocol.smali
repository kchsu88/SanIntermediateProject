.class public final Lccsanokhttp3/internal/ws/WebSocketProtocol;
...
.method static toggleMask(Lccsanokio/Buffer$UnsafeCursor;[B)V
    .locals 7
    .param p0, "cursor"    # Lccsanokio/Buffer$UnsafeCursor;
    .param p1, "key"    # [B
    ...
    :goto_0
    iget-object v2, p0, Lccsanokio/Buffer$UnsafeCursor;->data:[B
    ...
    .local v3, "i":I
    iget v4, p0, Lccsanokio/Buffer$UnsafeCursor;->end:I
    ...
    .end local v4    # "end":I
    :cond_0
    invoke-virtual {p0}, Lccsanokio/Buffer$UnsafeCursor;->next()I
...
.method static validateCloseCode(I)V
    ...
    .line 118
    invoke-static {p0}, Lccsanokhttp3/internal/ws/WebSocketProtocol;->closeCodeExceptionMessage(I)Ljava/lang/String;
