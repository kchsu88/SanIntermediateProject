.class public final Lccsankotlin/time/jdk8/DurationConversionsJDK8Kt;
...
.method private static final toJavaDuration-LRDsOJo(J)Ljava/time/Duration;
    ...
    .line 37
    invoke-static {v1, v2}, Lccsankotlin/time/Duration;->getInWholeSeconds-impl(J)J

    move-result-wide v4

    .local v4, "seconds":J
    invoke-static {v1, v2}, Lccsankotlin/time/Duration;->getNanosecondsComponent-impl(J)I
...
.method private static final toKotlinDuration(Ljava/time/Duration;)J
    ...
    sget-object v1, Lccsankotlin/time/Duration;->Companion:Lccsankotlin/time/Duration$Companion;

    invoke-virtual {p0}, Ljava/time/Duration;->getSeconds()J

    move-result-wide v2

    invoke-virtual {v1, v2, v3}, Lccsankotlin/time/Duration$Companion;->seconds-UwyO8pc(J)J

    move-result-wide v1

    sget-object v3, Lccsankotlin/time/Duration;->Companion:Lccsankotlin/time/Duration$Companion;

    invoke-virtual {p0}, Ljava/time/Duration;->getNano()I

    move-result v4

    invoke-virtual {v3, v4}, Lccsankotlin/time/Duration$Companion;->nanoseconds-UwyO8pc(I)J

    move-result-wide v3

    invoke-static {v1, v2, v3, v4}, Lccsankotlin/time/Duration;->plus-LRDsOJo(JJ)J
