.class Lccsankotlin/collections/GroupingKt__GroupingJVMKt;
...
.method public static final eachCount(Lccsankotlin/collections/Grouping;)Ljava/util/Map;
    .locals 22
    .param p0, "$this$eachCount"    # Lccsankotlin/collections/Grouping;
    ...
    invoke-static {v1, v0}, Lccsankotlin/jvm/internal/Intrinsics;->checkNotNullParameter(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    .local v2, "$this$foldTo$iv":Lccsankotlin/collections/Grouping;
    const/4 v3, 0x0
    ...
    .local v4, "$this$aggregateTo$iv$iv":Lccsankotlin/collections/Grouping;
    const/4 v5, 0x0
    ...
    invoke-interface {v4, v7}, Lccsankotlin/collections/Grouping;->keyOf(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    new-instance v19, Lccsankotlin/jvm/internal/Ref$IntRef;

    invoke-direct/range {v19 .. v19}, Lccsankotlin/jvm/internal/Ref$IntRef;-><init>()V
    ...
    check-cast v10, Lccsankotlin/jvm/internal/Ref$IntRef;

    .local v10, "acc":Lccsankotlin/jvm/internal/Ref$IntRef;
    move-object/from16 v17, v13
    ...
    .line 59
    .local v20, "$this$apply":Lccsankotlin/jvm/internal/Ref$IntRef;
    const/16 v21, 0x0
    ...
    .end local v2    # "$this$foldTo$iv":Lccsankotlin/collections/Grouping;
    .local v1, "$this$apply":Lccsankotlin/jvm/internal/Ref$IntRef;
    .local v20, "$this$foldTo$iv":Lccsankotlin/collections/Grouping;
    ...
    iput v2, v1, Lccsankotlin/jvm/internal/Ref$IntRef;->element:I

    .end local v1    # "$this$apply":Lccsankotlin/jvm/internal/Ref$IntRef;
    .end local v10    # "acc":Lccsankotlin/jvm/internal/Ref$IntRef;
    ...
    .line 60
    .end local v20    # "$this$foldTo$iv":Lccsankotlin/collections/Grouping;
    .restart local v2    # "$this$foldTo$iv":Lccsankotlin/collections/Grouping;
    :cond_2
    move-object/from16 v20, v2

    .line 54
    .end local v2    # "$this$foldTo$iv":Lccsankotlin/collections/Grouping;
    .end local v4    # "$this$aggregateTo$iv$iv":Lccsankotlin/collections/Grouping;
    .end local v5    # "$i$f$aggregateTo":I
    .restart local v20    # "$this$foldTo$iv":Lccsankotlin/collections/Grouping;
    nop
    ...
    invoke-static {v2}, Lccsankotlin/jvm/internal/TypeIntrinsics;->asMutableMapEntry(Ljava/lang/Object;)Ljava/util/Map$Entry;
    ...
    check-cast v5, Lccsankotlin/jvm/internal/Ref$IntRef;

    iget v2, v5, Lccsankotlin/jvm/internal/Ref$IntRef;->element:I
    ...
    :cond_4
    invoke-static {v0}, Lccsankotlin/jvm/internal/TypeIntrinsics;->asMutableMap(Ljava/lang/Object;)Ljava/util/Map;
...
.method private static final mapValuesInPlace(Ljava/util/Map;Lccsankotlin/jvm/functions/Function1;)Ljava/util/Map;
    .locals 9
    .param p0, "$this$mapValuesInPlace"    # Ljava/util/Map;
    .param p1, "f"    # Lccsankotlin/jvm/functions/Function1;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
            "Ljava/lang/Object;",
    ...
    invoke-static {v5}, Lccsankotlin/jvm/internal/TypeIntrinsics;->asMutableMapEntry(Ljava/lang/Object;)Ljava/util/Map$Entry;
