.class public final Lccsankotlin/io/TextStreamsKt;
...
.annotation runtime Lccsankotlin/Metadata;
    ...
    d2 = {
        ...
        "(Ljava/io/Reader;Lccsankotlin/jvm/functions/Function1;)Ljava/lang/Object;",
        "kotlin-stdlib"
    }
    k = 0x2
    mv = {
...
.method public static synthetic copyTo$default(Ljava/io/Reader;Ljava/io/Writer;IILjava/lang/Object;)J
    ...
    :cond_0
    invoke-static {p0, p1, p2}, Lccsankotlin/io/TextStreamsKt;->copyTo(Ljava/io/Reader;Ljava/io/Writer;I)J
...
.method public static final forEachLine(Ljava/io/Reader;Lccsankotlin/jvm/functions/Function1;)V
    .locals 13
    ...
    invoke-static {v4}, Lccsankotlin/io/TextStreamsKt;->lineSequence(Ljava/io/BufferedReader;)Lccsankotlin/sequences/Sequence;

    move-result-object v6

    .local v6, "it":Lccsankotlin/sequences/Sequence;
    const/4 v7, 0x0
    ...
    .local v8, "action$iv":Lccsankotlin/jvm/functions/Function1;
    move-object v9, v6

    .local v9, "$this$forEach$iv":Lccsankotlin/sequences/Sequence;
    const/4 v10, 0x0

    .line 155
    .local v10, "$i$f$forEach":I
    invoke-interface {v9}, Lccsankotlin/sequences/Sequence;->iterator()Ljava/util/Iterator;
    ...
    invoke-interface {v8, v12}, Lccsankotlin/jvm/functions/Function1;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 33
    .end local v8    # "action$iv":Lccsankotlin/jvm/functions/Function1;
    .end local v9    # "$this$forEach$iv":Lccsankotlin/sequences/Sequence;
    .end local v10    # "$i$f$forEach":I
    nop

    .end local v6    # "it":Lccsankotlin/sequences/Sequence;
    .end local v7    # "$i$a$-useLines-TextStreamsKt$forEachLine$1":I
    sget-object v6, Lccsankotlin/Unit;->INSTANCE:Lccsankotlin/Unit;
    :try_end_0
    ...
    invoke-static {v2, v3}, Lccsankotlin/io/CloseableKt;->closeFinally(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    .end local p1    # "action":Lccsankotlin/jvm/functions/Function1;
    :try_start_1
    throw v3
    :try_end_1
    ...
    .restart local p1    # "action":Lccsankotlin/jvm/functions/Function1;
    :catchall_1
    move-exception v4
...
.method public static final lineSequence(Ljava/io/BufferedReader;)Lccsankotlin/sequences/Sequence;
    .locals 1
    ...
    .line 70
    new-instance v0, Lccsankotlin/io/LinesSequence;

    invoke-direct {v0, p0}, Lccsankotlin/io/LinesSequence;-><init>(Ljava/io/BufferedReader;)V

    check-cast v0, Lccsankotlin/sequences/Sequence;

    invoke-static {v0}, Lccsankotlin/sequences/SequencesKt;->constrainOnce(Lccsankotlin/sequences/Sequence;)Lccsankotlin/sequences/Sequence;
...
.method public static final readBytes(Ljava/net/URL;)[B
    ...
    invoke-static {v2}, Lccsankotlin/io/ByteStreamsKt;->readBytes(Ljava/io/InputStream;)[B
...
.method public static final readLines(Ljava/io/Reader;)Ljava/util/List;
    ...
    new-instance v1, Lccsankotlin/io/TextStreamsKt$readLines$1;

    invoke-direct {v1, v0}, Lccsankotlin/io/TextStreamsKt$readLines$1;-><init>(Ljava/util/ArrayList;)V

    check-cast v1, Lccsankotlin/jvm/functions/Function1;

    invoke-static {p0, v1}, Lccsankotlin/io/TextStreamsKt;->forEachLine(Ljava/io/Reader;Lccsankotlin/jvm/functions/Function1;)V
...
.method public static final readText(Ljava/io/Reader;)Ljava/lang/String;
    ...
    invoke-static {p0, v1, v2, v3, v4}, Lccsankotlin/io/TextStreamsKt;->copyTo$default(Ljava/io/Reader;Ljava/io/Writer;IILjava/lang/Object;)J
...
.method private static final readText(Ljava/net/URL;Ljava/nio/charset/Charset;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lccsankotlin/io/TextStreamsKt;->readBytes(Ljava/net/URL;)[B
...
.method public static final useLines(Ljava/io/Reader;Lccsankotlin/jvm/functions/Function1;)Ljava/lang/Object;
    .locals 8
    ...
    .end local p1    # "block":Lccsankotlin/jvm/functions/Function1;
    :try_start_1
    throw v2
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1
    ...
    .restart local p1    # "block":Lccsankotlin/jvm/functions/Function1;
    :catchall_1
    move-exception v5
