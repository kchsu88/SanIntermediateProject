.class public final Lccsancom/google/common/util/concurrent/SimpleTimeLimiter;
.super Ljava/lang/Object;
.source "SimpleTimeLimiter.java"

# interfaces
.implements Lccsancom/google/common/util/concurrent/TimeLimiter;
...
.method private constructor <init>(Ljava/util/concurrent/ExecutorService;)V
    ...
    iput-object v0, p0, Lccsancom/google/common/util/concurrent/SimpleTimeLimiter;->executor:Ljava/util/concurrent/ExecutorService;
...
.method static synthetic access$000(Ljava/lang/Exception;Z)Ljava/lang/Exception;
    ...
    .line 48
    invoke-static {p0, p1}, Lccsancom/google/common/util/concurrent/SimpleTimeLimiter;->throwCause(Ljava/lang/Exception;Z)Ljava/lang/Exception;
...
.method static synthetic access$100(Lccsancom/google/common/util/concurrent/SimpleTimeLimiter;Ljava/util/concurrent/Callable;JLjava/util/concurrent/TimeUnit;Z)Ljava/lang/Object;
    .locals 1
    .param p0, "x0"    # Lccsancom/google/common/util/concurrent/SimpleTimeLimiter;
    ...
    .line 48
    invoke-direct/range {p0 .. p5}, Lccsancom/google/common/util/concurrent/SimpleTimeLimiter;->callWithTimeout(Ljava/util/concurrent/Callable;JLjava/util/concurrent/TimeUnit;Z)Ljava/lang/Object;
...
.method private callWithTimeout(Ljava/util/concurrent/Callable;JLjava/util/concurrent/TimeUnit;Z)Ljava/lang/Object;
    ...
    .line 122
    invoke-static {p2, p3}, Lccsancom/google/common/util/concurrent/SimpleTimeLimiter;->checkPositiveTimeout(J)V

    .line 124
    iget-object v0, p0, Lccsancom/google/common/util/concurrent/SimpleTimeLimiter;->executor:Ljava/util/concurrent/ExecutorService;
    ...
    :cond_0
    invoke-static {v0, p2, p3, p4}, Lccsancom/google/common/util/concurrent/Uninterruptibles;->getUninterruptibly(Ljava/util/concurrent/Future;JLjava/util/concurrent/TimeUnit;)Ljava/lang/Object;
    ...
    .line 141
    new-instance v1, Lccsancom/google/common/util/concurrent/UncheckedTimeoutException;

    invoke-direct {v1, v2}, Lccsancom/google/common/util/concurrent/UncheckedTimeoutException;-><init>(Ljava/lang/Throwable;)V
    ...
    invoke-static {v2, v1}, Lccsancom/google/common/util/concurrent/SimpleTimeLimiter;->throwCause(Ljava/lang/Exception;Z)Ljava/lang/Exception;
...
.method public static create(Ljava/util/concurrent/ExecutorService;)Lccsancom/google/common/util/concurrent/SimpleTimeLimiter;
    .locals 1
    .param p0, "executor"    # Ljava/util/concurrent/ExecutorService;

    .line 68
    new-instance v0, Lccsancom/google/common/util/concurrent/SimpleTimeLimiter;

    invoke-direct {v0, p0}, Lccsancom/google/common/util/concurrent/SimpleTimeLimiter;-><init>(Ljava/util/concurrent/ExecutorService;)V
...
.method private static findInterruptibleMethods(Ljava/lang/Class;)Ljava/util/Set;
    ...
    invoke-static {v4}, Lccsancom/google/common/util/concurrent/SimpleTimeLimiter;->declaresInterruptedEx(Ljava/lang/reflect/Method;)Z
...
.method private static throwCause(Ljava/lang/Exception;Z)Ljava/lang/Exception;
    ...
    invoke-static {v1, v2, v3}, Lccsancom/google/common/collect/ObjectArrays;->concat([Ljava/lang/Object;[Ljava/lang/Object;Ljava/lang/Class;)[Ljava/lang/Object;
...
.method private wrapAndThrowExecutionExceptionOrError(Ljava/lang/Throwable;)V
    ...
    invoke-direct {v0, p1}, Lccsancom/google/common/util/concurrent/UncheckedExecutionException;-><init>(Ljava/lang/Throwable;)V
...
.method public callUninterruptiblyWithTimeout(Ljava/util/concurrent/Callable;JLjava/util/concurrent/TimeUnit;)Ljava/lang/Object;
    ...
    invoke-direct {p0, v2}, Lccsancom/google/common/util/concurrent/SimpleTimeLimiter;->wrapAndThrowExecutionExceptionOrError(Ljava/lang/Throwable;)V
...
.method public newProxy(Ljava/lang/Object;Ljava/lang/Class;JLjava/util/concurrent/TimeUnit;)Ljava/lang/Object;
    ...
    .line 80
    invoke-static {p3, p4}, Lccsancom/google/common/util/concurrent/SimpleTimeLimiter;->checkPositiveTimeout(J)V
    ...
    .line 83
    invoke-static {p2}, Lccsancom/google/common/util/concurrent/SimpleTimeLimiter;->findInterruptibleMethods(Ljava/lang/Class;)Ljava/util/Set;

    move-result-object v0

    .line 85
    .local v0, "interruptibleMethods":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/reflect/Method;>;"
    new-instance v1, Lccsancom/google/common/util/concurrent/SimpleTimeLimiter$1;
    ...
    invoke-direct/range {v2 .. v8}, Lccsancom/google/common/util/concurrent/SimpleTimeLimiter$1;-><init>(Lccsancom/google/common/util/concurrent/SimpleTimeLimiter;Ljava/lang/Object;JLjava/util/concurrent/TimeUnit;Ljava/util/Set;)V

    .line 105
    .local v1, "handler":Ljava/lang/reflect/InvocationHandler;
    invoke-static {p2, v1}, Lccsancom/google/common/util/concurrent/SimpleTimeLimiter;->newProxy(Ljava/lang/Class;Ljava/lang/reflect/InvocationHandler;)Ljava/lang/Object;
...
.method public runUninterruptiblyWithTimeout(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)V
    ...
    invoke-direct {p0, v2}, Lccsancom/google/common/util/concurrent/SimpleTimeLimiter;->wrapAndThrowRuntimeExecutionExceptionOrError(Ljava/lang/Throwable;)V
