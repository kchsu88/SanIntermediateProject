.class abstract Lccsancom/google/common/util/concurrent/WrappingExecutorService;
...
.method protected constructor <init>(Ljava/util/concurrent/ExecutorService;)V
    ...
    iput-object v0, p0, Lccsancom/google/common/util/concurrent/WrappingExecutorService;->delegate:Ljava/util/concurrent/ExecutorService;

    .line 50
    return-void
.end method

.method private wrapTasks(Ljava/util/Collection;)Lccsancom/google/common/collect/ImmutableList;
    .locals 4
    ...
    .line 84
    .local v0, "builder":Lccsancom/google/common/collect/ImmutableList$Builder;, "Lccsancom/google/common/collect/ImmutableList$Builder<Ljava/util/concurrent/Callable<TT;>;>;"
    ...
    invoke-virtual {p0, v2}, Lccsancom/google/common/util/concurrent/WrappingExecutorService;->wrapTask(Ljava/util/concurrent/Callable;)Ljava/util/concurrent/Callable;
...
.method public final awaitTermination(JLjava/util/concurrent/TimeUnit;)Z
    ...
    .line 160
    iget-object v0, p0, Lccsancom/google/common/util/concurrent/WrappingExecutorService;->delegate:Ljava/util/concurrent/ExecutorService;
...
.method public final execute(Ljava/lang/Runnable;)V
    ...
    invoke-virtual {p0, p1}, Lccsancom/google/common/util/concurrent/WrappingExecutorService;->wrapTask(Ljava/lang/Runnable;)Ljava/lang/Runnable;
...
.method public final invokeAll(Ljava/util/Collection;)Ljava/util/List;
    ...
    invoke-direct {p0, p1}, Lccsancom/google/common/util/concurrent/WrappingExecutorService;->wrapTasks(Ljava/util/Collection;)Lccsancom/google/common/collect/ImmutableList;
...
.method public final submit(Ljava/util/concurrent/Callable;)Ljava/util/concurrent/Future;
    ...
    invoke-virtual {p0, v1}, Lccsancom/google/common/util/concurrent/WrappingExecutorService;->wrapTask(Ljava/util/concurrent/Callable;)Ljava/util/concurrent/Callable;
...
.method protected wrapTask(Ljava/lang/Runnable;)Ljava/lang/Runnable;
    ...
    invoke-virtual {p0, v0}, Lccsancom/google/common/util/concurrent/WrappingExecutorService;->wrapTask(Ljava/util/concurrent/Callable;)Ljava/util/concurrent/Callable;

    move-result-object v0

    .line 64
    .local v0, "wrapped":Ljava/util/concurrent/Callable;, "Ljava/util/concurrent/Callable<Ljava/lang/Object;>;"
    new-instance v1, Lccsancom/google/common/util/concurrent/WrappingExecutorService$1;

    invoke-direct {v1, p0, v0}, Lccsancom/google/common/util/concurrent/WrappingExecutorService$1;-><init>(Lccsancom/google/common/util/concurrent/WrappingExecutorService;Ljava/util/concurrent/Callable;)V
