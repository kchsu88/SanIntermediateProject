.class public final Lccsancom/google/android/exoplayer2/metadata/dvbsi/AppInfoTableDecoder;
...
.method private static parseAit(Lccsancom/google/android/exoplayer2/util/ParsableBitArray;)Lccsancom/google/android/exoplayer2/metadata/Metadata;
    .locals 20
    .param p0, "sectionData"    # Lccsancom/google/android/exoplayer2/util/ParsableBitArray;
    ...
    invoke-virtual/range {p0 .. p0}, Lccsancom/google/android/exoplayer2/util/ParsableBitArray;->getBytePosition()I
    ...
    invoke-virtual {v0, v5}, Lccsancom/google/android/exoplayer2/util/ParsableBitArray;->skipBytes(I)V

    .line 75
    const/16 v6, 0x10

    invoke-virtual {v0, v6}, Lccsancom/google/android/exoplayer2/util/ParsableBitArray;->skipBits(I)V
    ...
    .line 78
    .local v7, "appInfoTables":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lccsancom/google/android/exoplayer2/metadata/dvbsi/AppInfoTable;>;"
    :goto_0
    invoke-virtual/range {p0 .. p0}, Lccsancom/google/android/exoplayer2/util/ParsableBitArray;->getBytePosition()I
    ...
    invoke-virtual {v0, v10}, Lccsancom/google/android/exoplayer2/util/ParsableBitArray;->skipBits(I)V
    ...
    sget-object v10, Lccsancom/google/common/base/Charsets;->US_ASCII:Ljava/nio/charset/Charset;

    invoke-virtual {v0, v6, v10}, Lccsancom/google/android/exoplayer2/util/ParsableBitArray;->readBytesAsString(ILjava/nio/charset/Charset;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v3}, Lccsancom/google/android/exoplayer2/util/ParsableBitArray;->skipBytes(I)V
    ...
    .line 121
    sget-object v3, Lccsancom/google/common/base/Charsets;->US_ASCII:Ljava/nio/charset/Charset;

    invoke-virtual {v0, v15, v3}, Lccsancom/google/android/exoplayer2/util/ParsableBitArray;->readBytesAsString(ILjava/nio/charset/Charset;)Ljava/lang/String;
    ...
    .line 130
    new-instance v1, Lccsancom/google/android/exoplayer2/metadata/dvbsi/AppInfoTable;
    ...
    :goto_6
    invoke-direct {v1, v11, v2}, Lccsancom/google/android/exoplayer2/metadata/dvbsi/AppInfoTable;-><init>(ILjava/lang/String;)V
    ...
    invoke-direct {v1, v7}, Lccsancom/google/android/exoplayer2/metadata/Metadata;-><init>(Ljava/util/List;)V
...
.method protected decode(Lccsancom/google/android/exoplayer2/metadata/MetadataInputBuffer;Ljava/nio/ByteBuffer;)Lccsancom/google/android/exoplayer2/metadata/Metadata;
    ...
    invoke-static {v1}, Lccsancom/google/android/exoplayer2/metadata/dvbsi/AppInfoTableDecoder;->parseAit(Lccsancom/google/android/exoplayer2/util/ParsableBitArray;)Lccsancom/google/android/exoplayer2/metadata/Metadata;
