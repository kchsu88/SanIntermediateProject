.class public Lccsancom/google/android/exoplayer2/util/DebugTextViewHelper;
...
# instance fields
.field private final player:Lccsancom/google/android/exoplayer2/ExoPlayer;

.field private started:Z

.field private final textView:Lccsanandroid/widget/TextView;


# direct methods
.method public constructor <init>(Lccsancom/google/android/exoplayer2/ExoPlayer;Lccsanandroid/widget/TextView;)V
    .locals 2
    .param p1, "player"    # Lccsancom/google/android/exoplayer2/ExoPlayer;
    ...
    .line 47
    invoke-interface {p1}, Lccsancom/google/android/exoplayer2/ExoPlayer;->getApplicationLooper()Lccsanandroid/os/Looper;
    ...
    .line 48
    iput-object p1, p0, Lccsancom/google/android/exoplayer2/util/DebugTextViewHelper;->player:Lccsancom/google/android/exoplayer2/ExoPlayer;

    .line 49
    iput-object p2, p0, Lccsancom/google/android/exoplayer2/util/DebugTextViewHelper;->textView:Lccsanandroid/widget/TextView;

    .line 50
    return-void
.end method

.method private static getDecoderCountersBufferCountString(Lccsancom/google/android/exoplayer2/decoder/DecoderCounters;)Ljava/lang/String;
    .locals 8
    .param p0, "counters"    # Lccsancom/google/android/exoplayer2/decoder/DecoderCounters;
    ...
    .line 192
    :cond_0
    invoke-virtual {p0}, Lccsancom/google/android/exoplayer2/decoder/DecoderCounters;->ensureUpdated()V

    .line 193
    iget v0, p0, Lccsancom/google/android/exoplayer2/decoder/DecoderCounters;->skippedInputBufferCount:I

    iget v1, p0, Lccsancom/google/android/exoplayer2/decoder/DecoderCounters;->skippedOutputBufferCount:I

    iget v2, p0, Lccsancom/google/android/exoplayer2/decoder/DecoderCounters;->renderedOutputBufferCount:I

    iget v3, p0, Lccsancom/google/android/exoplayer2/decoder/DecoderCounters;->droppedBufferCount:I

    iget v4, p0, Lccsancom/google/android/exoplayer2/decoder/DecoderCounters;->maxConsecutiveDroppedBufferCount:I

    iget v5, p0, Lccsancom/google/android/exoplayer2/decoder/DecoderCounters;->droppedToKeyframeCount:I
...
.method protected getAudioString()Ljava/lang/String;
    ...
    .line 171
    iget-object v0, p0, Lccsancom/google/android/exoplayer2/util/DebugTextViewHelper;->player:Lccsancom/google/android/exoplayer2/ExoPlayer;

    invoke-interface {v0}, Lccsancom/google/android/exoplayer2/ExoPlayer;->getAudioFormat()Lccsancom/google/android/exoplayer2/Format;

    move-result-object v0

    .line 172
    .local v0, "format":Lccsancom/google/android/exoplayer2/Format;
    iget-object v1, p0, Lccsancom/google/android/exoplayer2/util/DebugTextViewHelper;->player:Lccsancom/google/android/exoplayer2/ExoPlayer;

    invoke-interface {v1}, Lccsancom/google/android/exoplayer2/ExoPlayer;->getAudioDecoderCounters()Lccsancom/google/android/exoplayer2/decoder/DecoderCounters;

    move-result-object v1

    .line 173
    .local v1, "decoderCounters":Lccsancom/google/android/exoplayer2/decoder/DecoderCounters;
    if-eqz v0, :cond_1
    ...
    .line 176
    :cond_0
    iget-object v2, v0, Lccsancom/google/android/exoplayer2/Format;->sampleMimeType:Ljava/lang/String;

    iget-object v3, v0, Lccsancom/google/android/exoplayer2/Format;->id:Ljava/lang/String;

    iget v4, v0, Lccsancom/google/android/exoplayer2/Format;->sampleRate:I

    iget v5, v0, Lccsancom/google/android/exoplayer2/Format;->channelCount:I

    .line 184
    invoke-static {v1}, Lccsancom/google/android/exoplayer2/util/DebugTextViewHelper;->getDecoderCountersBufferCountString(Lccsancom/google/android/exoplayer2/decoder/DecoderCounters;)Ljava/lang/String;
...
.method protected getDebugString()Ljava/lang/String;
    ...
    .line 117
    invoke-virtual {p0}, Lccsancom/google/android/exoplayer2/util/DebugTextViewHelper;->getPlayerStateString()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p0}, Lccsancom/google/android/exoplayer2/util/DebugTextViewHelper;->getVideoString()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p0}, Lccsancom/google/android/exoplayer2/util/DebugTextViewHelper;->getAudioString()Ljava/lang/String;
...
.method protected getPlayerStateString()Ljava/lang/String;
    ...
    invoke-interface {v0}, Lccsancom/google/android/exoplayer2/ExoPlayer;->getPlaybackState()I
    ...
    iget-object v3, p0, Lccsancom/google/android/exoplayer2/util/DebugTextViewHelper;->player:Lccsancom/google/android/exoplayer2/ExoPlayer;

    .line 142
    invoke-interface {v3}, Lccsancom/google/android/exoplayer2/ExoPlayer;->getPlayWhenReady()Z
    ...
    invoke-interface {v3}, Lccsancom/google/android/exoplayer2/ExoPlayer;->getCurrentMediaItemIndex()I
...
.method protected getVideoString()Ljava/lang/String;
    ...
    invoke-interface {v0}, Lccsancom/google/android/exoplayer2/ExoPlayer;->getVideoFormat()Lccsancom/google/android/exoplayer2/Format;
    ...
    invoke-interface {v1}, Lccsancom/google/android/exoplayer2/ExoPlayer;->getVideoDecoderCounters()Lccsancom/google/android/exoplayer2/decoder/DecoderCounters;
    ...
    iget v4, v0, Lccsancom/google/android/exoplayer2/Format;->width:I

    iget v5, v0, Lccsancom/google/android/exoplayer2/Format;->height:I

    iget v6, v0, Lccsancom/google/android/exoplayer2/Format;->pixelWidthHeightRatio:F

    .line 160
    invoke-static {v6}, Lccsancom/google/android/exoplayer2/util/DebugTextViewHelper;->getPixelAspectRatioString(F)Ljava/lang/String;
    ...
    iget-wide v8, v1, Lccsancom/google/android/exoplayer2/decoder/DecoderCounters;->totalVideoFrameProcessingOffsetUs:J

    iget v10, v1, Lccsancom/google/android/exoplayer2/decoder/DecoderCounters;->videoFrameProcessingOffsetCount:I

    .line 163
    invoke-static {v8, v9, v10}, Lccsancom/google/android/exoplayer2/util/DebugTextViewHelper;->getVideoFrameProcessingOffsetAverageString(JI)Ljava/lang/String;
...
.method public final onPlayWhenReadyChanged(ZI)V
    ...
    .line 88
    invoke-virtual {p0}, Lccsancom/google/android/exoplayer2/util/DebugTextViewHelper;->updateAndPost()V
...
.method public synthetic onPlayerError(Lccsancom/google/android/exoplayer2/PlaybackException;)V
    ...
    invoke-static {p0, p1}, Lccsancom/google/android/exoplayer2/Player$Listener$-CC;->$default$onPlayerError(Lccsancom/google/android/exoplayer2/Player$Listener;Lccsancom/google/android/exoplayer2/PlaybackException;)V
...
.method public synthetic onVideoSizeChanged(Lccsancom/google/android/exoplayer2/video/VideoSize;)V
    ...
    invoke-static {p0, p1}, Lccsancom/google/android/exoplayer2/Player$Listener$-CC;->$default$onVideoSizeChanged(Lccsancom/google/android/exoplayer2/Player$Listener;Lccsancom/google/android/exoplayer2/video/VideoSize;)V
...
.method public final start()V
    ...
    .line 57
    iget-boolean v0, p0, Lccsancom/google/android/exoplayer2/util/DebugTextViewHelper;->started:Z
    ...
    iput-boolean v0, p0, Lccsancom/google/android/exoplayer2/util/DebugTextViewHelper;->started:Z

    .line 61
    iget-object v0, p0, Lccsancom/google/android/exoplayer2/util/DebugTextViewHelper;->player:Lccsancom/google/android/exoplayer2/ExoPlayer;

    invoke-interface {v0, p0}, Lccsancom/google/android/exoplayer2/ExoPlayer;->addListener(Lccsancom/google/android/exoplayer2/Player$Listener;)V
...
.method public final stop()V
    ...
    invoke-interface {v0, p0}, Lccsancom/google/android/exoplayer2/ExoPlayer;->removeListener(Lccsancom/google/android/exoplayer2/Player$Listener;)V

    .line 75
    iget-object v0, p0, Lccsancom/google/android/exoplayer2/util/DebugTextViewHelper;->textView:Lccsanandroid/widget/TextView;

    invoke-virtual {v0, p0}, Lccsanandroid/widget/TextView;->removeCallbacks(Ljava/lang/Runnable;)Z
...
.method protected final updateAndPost()V
    ...
    invoke-virtual {p0}, Lccsancom/google/android/exoplayer2/util/DebugTextViewHelper;->getDebugString()Ljava/lang/String;
    ...
    invoke-virtual {v0, p0, v1, v2}, Lccsanandroid/widget/TextView;->postDelayed(Ljava/lang/Runnable;J)Z
