.class public Lccsancom/google/android/material/slider/RangeSlider;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lccsancom/google/android/material/slider/RangeSlider$OnSliderTouchListener;,
        Lccsancom/google/android/material/slider/RangeSlider$OnChangeListener;
    }
.end annotation
...
.annotation system Ldalvik/annotation/Signature;
    value = {
        ...
        "Lccsancom/google/android/material/slider/RangeSlider;",
        "Lccsancom/google/android/material/slider/RangeSlider$OnChangeListener;",
        "Lccsancom/google/android/material/slider/RangeSlider$OnSliderTouchListener;",
        ">;"
    }
...
.method public constructor <init>(Lccsanandroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v0}, Lccsancom/google/android/material/slider/RangeSlider;-><init>(Lccsanandroid/content/Context;Lccsanandroid/util/AttributeSet;)V
...
.method public constructor <init>(Lccsanandroid/content/Context;Lccsanandroid/util/AttributeSet;)V
    ...
    invoke-direct {p0, p1, p2, v0}, Lccsancom/google/android/material/slider/RangeSlider;-><init>(Lccsanandroid/content/Context;Lccsanandroid/util/AttributeSet;I)V
...
.method public constructor <init>(Lccsanandroid/content/Context;Lccsanandroid/util/AttributeSet;I)V
    ...
    .line 66
    sget-object v2, Lccsancom/google/android/material/R$styleable;->RangeSlider:[I

    sget v4, Lccsancom/google/android/material/slider/RangeSlider;->DEF_STYLE_RES:I
    ...
    sget v1, Lccsancom/google/android/material/R$styleable;->RangeSlider_values:I
    ...
    invoke-virtual {v2, v1}, Lccsanandroid/content/res/Resources;->obtainTypedArray(I)Lccsanandroid/content/res/TypedArray;

    move-result-object v2

    .line 72
    .local v2, "values":Lccsanandroid/content/res/TypedArray;
    invoke-static {v2}, Lccsancom/google/android/material/slider/RangeSlider;->convertToFloat(Lccsanandroid/content/res/TypedArray;)Ljava/util/List;

    move-result-object v3

    invoke-virtual {p0, v3}, Lccsancom/google/android/material/slider/RangeSlider;->setValues(Ljava/util/List;)V

    .line 75
    .end local v1    # "valuesId":I
    .end local v2    # "values":Lccsanandroid/content/res/TypedArray;
    :cond_0
    sget v1, Lccsancom/google/android/material/R$styleable;->RangeSlider_minSeparation:I
    ...
    iput v1, p0, Lccsancom/google/android/material/slider/RangeSlider;->minSeparation:F
...
.method private static convertToFloat(Lccsanandroid/content/res/TypedArray;)Ljava/util/List;
    .locals 3
    .param p0, "values"    # Lccsanandroid/content/res/TypedArray;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lccsanandroid/content/res/TypedArray;",
            ")",
            "Ljava/util/List<",
            "Ljava/lang/Float;",
            ">;"
    ...
    .local v1, "i":I
    :goto_0
    invoke-virtual {p0}, Lccsanandroid/content/res/TypedArray;->length()I
    ...
    invoke-virtual {p0, v1, v2}, Lccsanandroid/content/res/TypedArray;->getFloat(IF)F
...
.method public getMinSeparation()F
    ...
    .line 131
    iget v0, p0, Lccsancom/google/android/material/slider/RangeSlider;->minSeparation:F
...
.method public getValues()Ljava/util/List;
    ...
    .line 112
    invoke-super {p0}, Lccsancom/google/android/material/slider/BaseSlider;->getValues()Ljava/util/List;
...
.method protected onRestoreInstanceState(Lccsanandroid/os/Parcelable;)V
    ...
    check-cast v0, Lccsancom/google/android/material/slider/RangeSlider$RangeSliderState;

    .line 175
    .local v0, "savedState":Lccsancom/google/android/material/slider/RangeSlider$RangeSliderState;
    invoke-virtual {v0}, Lccsancom/google/android/material/slider/RangeSlider$RangeSliderState;->getSuperState()Lccsanandroid/os/Parcelable;

    move-result-object v1

    invoke-super {p0, v1}, Lccsancom/google/android/material/slider/BaseSlider;->onRestoreInstanceState(Lccsanandroid/os/Parcelable;)V

    .line 177
    invoke-static {v0}, Lccsancom/google/android/material/slider/RangeSlider$RangeSliderState;->access$000(Lccsancom/google/android/material/slider/RangeSlider$RangeSliderState;)F
    ...
    .line 178
    invoke-static {v0}, Lccsancom/google/android/material/slider/RangeSlider$RangeSliderState;->access$100(Lccsancom/google/android/material/slider/RangeSlider$RangeSliderState;)I

    move-result v1

    iput v1, p0, Lccsancom/google/android/material/slider/RangeSlider;->separationUnit:I

    .line 179
    invoke-virtual {p0, v1}, Lccsancom/google/android/material/slider/RangeSlider;->setSeparationUnit(I)V
...
.method public onSaveInstanceState()Lccsanandroid/os/Parcelable;
    ...
    .line 163
    invoke-super {p0}, Lccsancom/google/android/material/slider/BaseSlider;->onSaveInstanceState()Lccsanandroid/os/Parcelable;

    move-result-object v0

    .line 165
    .local v0, "superState":Lccsanandroid/os/Parcelable;
    new-instance v1, Lccsancom/google/android/material/slider/RangeSlider$RangeSliderState;

    invoke-direct {v1, v0}, Lccsancom/google/android/material/slider/RangeSlider$RangeSliderState;-><init>(Lccsanandroid/os/Parcelable;)V

    .line 166
    .local v1, "sliderState":Lccsancom/google/android/material/slider/RangeSlider$RangeSliderState;
    iget v2, p0, Lccsancom/google/android/material/slider/RangeSlider;->minSeparation:F

    invoke-static {v1, v2}, Lccsancom/google/android/material/slider/RangeSlider$RangeSliderState;->access$002(Lccsancom/google/android/material/slider/RangeSlider$RangeSliderState;F)F

    .line 167
    iget v2, p0, Lccsancom/google/android/material/slider/RangeSlider;->separationUnit:I

    invoke-static {v1, v2}, Lccsancom/google/android/material/slider/RangeSlider$RangeSliderState;->access$102(Lccsancom/google/android/material/slider/RangeSlider$RangeSliderState;I)I
...
.method public setMinSeparation(F)V
    ...
    .line 141
    iput p1, p0, Lccsancom/google/android/material/slider/RangeSlider;->minSeparation:F

    .line 142
    const/4 v0, 0x0

    iput v0, p0, Lccsancom/google/android/material/slider/RangeSlider;->separationUnit:I

    .line 143
    invoke-virtual {p0, v0}, Lccsancom/google/android/material/slider/RangeSlider;->setSeparationUnit(I)V
...
.method public setValues(Ljava/util/List;)V
    ...
    invoke-super {p0, p1}, Lccsancom/google/android/material/slider/BaseSlider;->setValues(Ljava/util/List;)V
...
.method public varargs setValues([Ljava/lang/Float;)V
    ...
    .line 95
    invoke-super {p0, p1}, Lccsancom/google/android/material/slider/BaseSlider;->setValues([Ljava/lang/Float;)V
