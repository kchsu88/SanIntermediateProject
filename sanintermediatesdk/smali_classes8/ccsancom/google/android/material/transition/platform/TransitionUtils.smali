.class Lccsancom/google/android/material/transition/platform/TransitionUtils;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lccsancom/google/android/material/transition/platform/TransitionUtils$CanvasOperation;,
        Lccsancom/google/android/material/transition/platform/TransitionUtils$CornerSizeBinaryOperator;
    }
.end annotation
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lccsancom/google/android/material/transition/platform/TransitionUtils;->transformAlphaRectF:Lccsanandroid/graphics/RectF;
...
.method static convertToRelativeCornerSizes(Lccsancom/google/android/material/shape/ShapeAppearanceModel;Lccsanandroid/graphics/RectF;)Lccsancom/google/android/material/shape/ShapeAppearanceModel;
    ...
    .line 52
    new-instance v0, Lccsancom/google/android/material/transition/platform/TransitionUtils$1;

    invoke-direct {v0, p1}, Lccsancom/google/android/material/transition/platform/TransitionUtils$1;-><init>(Lccsanandroid/graphics/RectF;)V
...
.method static findDescendantOrAncestorById(Lccsanandroid/view/View;I)Lccsanandroid/view/View;
    ...
    .line 206
    :cond_0
    invoke-static {p0, p1}, Lccsancom/google/android/material/transition/platform/TransitionUtils;->findAncestorById(Lccsanandroid/view/View;I)Lccsanandroid/view/View;
...
.method static lerp(FFFFFZ)F
    ...
    .line 135
    :cond_0
    invoke-static {p0, p1, p4}, Lccsancom/google/android/material/transition/platform/TransitionUtils;->lerp(FFF)F
    ...
    invoke-static {p0, p1, v0}, Lccsancom/google/android/material/transition/platform/TransitionUtils;->lerp(FFF)F
...
.method static lerp(IIFFF)I
    ...
    .line 160
    invoke-static {v0, v1, v2}, Lccsancom/google/android/material/transition/platform/TransitionUtils;->lerp(FFF)F
...
.method static lerp(Lccsancom/google/android/material/shape/ShapeAppearanceModel;Lccsancom/google/android/material/shape/ShapeAppearanceModel;Lccsanandroid/graphics/RectF;Lccsanandroid/graphics/RectF;FFF)Lccsancom/google/android/material/shape/ShapeAppearanceModel;
    ...
    .line 178
    :cond_1
    new-instance v0, Lccsancom/google/android/material/transition/platform/TransitionUtils$2;
    ...
    invoke-direct/range {v1 .. v6}, Lccsancom/google/android/material/transition/platform/TransitionUtils$2;-><init>(Lccsanandroid/graphics/RectF;Lccsanandroid/graphics/RectF;FFF)V

    invoke-static {p0, p1, p2, v0}, Lccsancom/google/android/material/transition/platform/TransitionUtils;->transformCornerSizes(Lccsancom/google/android/material/shape/ShapeAppearanceModel;Lccsancom/google/android/material/shape/ShapeAppearanceModel;Lccsanandroid/graphics/RectF;Lccsancom/google/android/material/transition/platform/TransitionUtils$CornerSizeBinaryOperator;)Lccsancom/google/android/material/shape/ShapeAppearanceModel;
...
.method static maybeAddTransition(Lccsanandroid/transition/TransitionSet;Lccsanandroid/transition/Transition;)V
    .locals 0
    .param p0, "transitionSet"    # Lccsanandroid/transition/TransitionSet;
    ...
    .line 296
    invoke-virtual {p0, p1}, Lccsanandroid/transition/TransitionSet;->addTransition(Lccsanandroid/transition/Transition;)Lccsanandroid/transition/TransitionSet;
...
.method static maybeRemoveTransition(Lccsanandroid/transition/TransitionSet;Lccsanandroid/transition/Transition;)V
    .locals 0
    .param p0, "transitionSet"    # Lccsanandroid/transition/TransitionSet;
    .param p1, "transition"    # Lccsanandroid/transition/Transition;
    ...
    .line 302
    invoke-virtual {p0, p1}, Lccsanandroid/transition/TransitionSet;->removeTransition(Lccsanandroid/transition/Transition;)Lccsanandroid/transition/TransitionSet;
...
.method private static saveLayerAlphaCompat(Lccsanandroid/graphics/Canvas;Lccsanandroid/graphics/Rect;I)I
    ...
    .line 255
    sget-object v0, Lccsancom/google/android/material/transition/platform/TransitionUtils;->transformAlphaRectF:Lccsanandroid/graphics/RectF;
...
.method static transform(Lccsanandroid/graphics/Canvas;Lccsanandroid/graphics/Rect;FFFILccsancom/google/android/material/transition/platform/TransitionUtils$CanvasOperation;)V
    .locals 2
    .param p0, "canvas"    # Lccsanandroid/graphics/Canvas;
    .param p1, "bounds"    # Lccsanandroid/graphics/Rect;
    .param p2, "dx"    # F
    ...
    .param p4, "scale"    # F
    .param p5, "alpha"    # I
    .param p6, "op"    # Lccsancom/google/android/material/transition/platform/TransitionUtils$CanvasOperation;
    ...
    .line 284
    invoke-static {p0, p1, p5}, Lccsancom/google/android/material/transition/platform/TransitionUtils;->saveLayerAlphaCompat(Lccsanandroid/graphics/Canvas;Lccsanandroid/graphics/Rect;I)I

    .line 286
    :cond_1
    invoke-interface {p6, p0}, Lccsancom/google/android/material/transition/platform/TransitionUtils$CanvasOperation;->run(Lccsanandroid/graphics/Canvas;)V
...
.method static transformCornerSizes(Lccsancom/google/android/material/shape/ShapeAppearanceModel;Lccsancom/google/android/material/shape/ShapeAppearanceModel;Lccsanandroid/graphics/RectF;Lccsancom/google/android/material/transition/platform/TransitionUtils$CornerSizeBinaryOperator;)Lccsancom/google/android/material/shape/ShapeAppearanceModel;
    ...
    .param p3, "op"    # Lccsancom/google/android/material/transition/platform/TransitionUtils$CornerSizeBinaryOperator;

    .line 74
    nop

    .line 75
    invoke-static {p0, p2}, Lccsancom/google/android/material/transition/platform/TransitionUtils;->isShapeAppearanceSignificant(Lccsancom/google/android/material/shape/ShapeAppearanceModel;Lccsanandroid/graphics/RectF;)Z
    ...
    .line 81
    invoke-interface {p3, v2, v3}, Lccsancom/google/android/material/transition/platform/TransitionUtils$CornerSizeBinaryOperator;->apply(Lccsancom/google/android/material/shape/CornerSize;Lccsancom/google/android/material/shape/CornerSize;)Lccsancom/google/android/material/shape/CornerSize;
