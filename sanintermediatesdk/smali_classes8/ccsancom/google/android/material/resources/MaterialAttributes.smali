.class public Lccsancom/google/android/material/resources/MaterialAttributes;
...
.method public static resolve(Lccsanandroid/content/Context;I)Lccsanandroid/util/TypedValue;
    .locals 3
...
.method public static resolveBoolean(Lccsanandroid/content/Context;IZ)Z
    .locals 3
    .param p0, "context"    # Lccsanandroid/content/Context;
    .param p1, "attributeResId"    # I
...
.method public static resolveBooleanOrThrow(Lccsanandroid/content/Context;ILjava/lang/String;)Z
    .locals 1
    .param p0, "context"    # Lccsanandroid/content/Context;
    .param p1, "attributeResId"    # I
...
.method public static resolveDimension(Lccsanandroid/content/Context;II)I
    .locals 3
    .param p0, "context"    # Lccsanandroid/content/Context;
    .param p1, "attributeResId"    # I
    ...
    .line 127
    .local v0, "dimensionValue":Lccsanandroid/util/TypedValue;
    if-eqz v0, :cond_1
...
.method public static resolveMinimumAccessibleTouchTarget(Lccsanandroid/content/Context;)I
    .locals 2
    .param p0, "context"    # Lccsanandroid/content/Context;

    .line 115
    sget v0, Lccsancom/google/android/material/R$attr;->minTouchTargetSize:I

    sget v1, Lccsancom/google/android/material/R$dimen;->mtrl_min_touch_target_size:I

    invoke-static {p0, v0, v1}, Lccsancom/google/android/material/resources/MaterialAttributes;->resolveDimension(Lccsanandroid/content/Context;II)I
...
.method public static resolveOrThrow(Lccsanandroid/content/Context;ILjava/lang/String;)I
    .locals 6
    .param p0, "context"    # Lccsanandroid/content/Context;
    .param p1, "attributeResId"    # I
    .param p2, "errorMessageComponent"    # Ljava/lang/String;
    ...
    invoke-virtual {v5, p1}, Lccsanandroid/content/res/Resources;->getResourceName(I)Ljava/lang/String;
...
.method public static resolveOrThrow(Lccsanandroid/view/View;I)I
    .locals 2
    .param p0, "componentView"    # Lccsanandroid/view/View;
    .param p1, "attributeResId"    # I
    ...
    .line 84
    invoke-static {v0, p1, v1}, Lccsancom/google/android/material/resources/MaterialAttributes;->resolveOrThrow(Lccsanandroid/content/Context;ILjava/lang/String;)I
