.class final Lccsancom/google/common/collect/DenseImmutableTable$RowMap;
...
.method private constructor <init>(Lccsancom/google/common/collect/DenseImmutableTable;)V
    ...
    .line 191
    .local p0, "this":Lccsancom/google/common/collect/DenseImmutableTable$RowMap;, "Lccsancom/google/common/collect/DenseImmutableTable<TR;TC;TV;>.RowMap;"
    iput-object p1, p0, Lccsancom/google/common/collect/DenseImmutableTable$RowMap;->this$0:Lccsancom/google/common/collect/DenseImmutableTable;
...
.method synthetic constructor <init>(Lccsancom/google/common/collect/DenseImmutableTable;Lccsancom/google/common/collect/DenseImmutableTable$1;)V
    ...
    .line 190
    .local p0, "this":Lccsancom/google/common/collect/DenseImmutableTable$RowMap;, "Lccsancom/google/common/collect/DenseImmutableTable<TR;TC;TV;>.RowMap;"
    invoke-direct {p0, p1}, Lccsancom/google/common/collect/DenseImmutableTable$RowMap;-><init>(Lccsancom/google/common/collect/DenseImmutableTable;)V
...
.method getValue(I)Lccsancom/google/common/collect/ImmutableMap;
    ...
    .line 202
    .local p0, "this":Lccsancom/google/common/collect/DenseImmutableTable$RowMap;, "Lccsancom/google/common/collect/DenseImmutableTable<TR;TC;TV;>.RowMap;"
    new-instance v0, Lccsancom/google/common/collect/DenseImmutableTable$Row;

    iget-object v1, p0, Lccsancom/google/common/collect/DenseImmutableTable$RowMap;->this$0:Lccsancom/google/common/collect/DenseImmutableTable;

    invoke-direct {v0, v1, p1}, Lccsancom/google/common/collect/DenseImmutableTable$Row;-><init>(Lccsancom/google/common/collect/DenseImmutableTable;I)V
...
.method bridge synthetic getValue(I)Ljava/lang/Object;
    ...
    .line 189
    .local p0, "this":Lccsancom/google/common/collect/DenseImmutableTable$RowMap;, "Lccsancom/google/common/collect/DenseImmutableTable<TR;TC;TV;>.RowMap;"
    invoke-virtual {p0, p1}, Lccsancom/google/common/collect/DenseImmutableTable$RowMap;->getValue(I)Lccsancom/google/common/collect/ImmutableMap;
...
.method keyToIndex()Lccsancom/google/common/collect/ImmutableMap;
    ...
    .line 197
    .local p0, "this":Lccsancom/google/common/collect/DenseImmutableTable$RowMap;, "Lccsancom/google/common/collect/DenseImmutableTable<TR;TC;TV;>.RowMap;"
    iget-object v0, p0, Lccsancom/google/common/collect/DenseImmutableTable$RowMap;->this$0:Lccsancom/google/common/collect/DenseImmutableTable;
