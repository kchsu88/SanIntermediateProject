.class abstract Lccsancom/google/common/graph/AbstractBaseGraph;
...
.method constructor <init>()V
    ...
    .line 44
    .local p0, "this":Lccsancom/google/common/graph/AbstractBaseGraph;, "Lccsancom/google/common/graph/AbstractBaseGraph<TN;>;"
...
.method public degree(Ljava/lang/Object;)I
    ...
    invoke-virtual {p0}, Lccsancom/google/common/graph/AbstractBaseGraph;->isDirected()Z
    ...
    .line 110
    invoke-virtual {p0, p1}, Lccsancom/google/common/graph/AbstractBaseGraph;->predecessors(Ljava/lang/Object;)Ljava/util/Set;
    ...
    invoke-virtual {p0, p1}, Lccsancom/google/common/graph/AbstractBaseGraph;->successors(Ljava/lang/Object;)Ljava/util/Set;
    ...
    .line 112
    :cond_0
    invoke-virtual {p0, p1}, Lccsancom/google/common/graph/AbstractBaseGraph;->adjacentNodes(Ljava/lang/Object;)Ljava/util/Set;

    move-result-object v0

    .line 113
    .local v0, "neighbors":Ljava/util/Set;, "Ljava/util/Set<TN;>;"
    invoke-virtual {p0}, Lccsancom/google/common/graph/AbstractBaseGraph;->allowsSelfLoops()Z
    ...
    invoke-static {v2, v1}, Lccsancom/google/common/math/IntMath;->saturatedAdd(II)I
...
.method protected edgeCount()J
    ...
    invoke-virtual {p0}, Lccsancom/google/common/graph/AbstractBaseGraph;->nodes()Ljava/util/Set;
    ...
    invoke-virtual {p0, v3}, Lccsancom/google/common/graph/AbstractBaseGraph;->degree(Ljava/lang/Object;)I
...
.method public edges()Ljava/util/Set;
    ...
    .line 67
    .local p0, "this":Lccsancom/google/common/graph/AbstractBaseGraph;, "Lccsancom/google/common/graph/AbstractBaseGraph<TN;>;"
    new-instance v0, Lccsancom/google/common/graph/AbstractBaseGraph$1;

    invoke-direct {v0, p0}, Lccsancom/google/common/graph/AbstractBaseGraph$1;-><init>(Lccsancom/google/common/graph/AbstractBaseGraph;)V
...
.method public hasEdgeConnecting(Lccsancom/google/common/graph/EndpointPair;)Z
    ...
    .line 138
    invoke-virtual {p0, p1}, Lccsancom/google/common/graph/AbstractBaseGraph;->isOrderingCompatible(Lccsancom/google/common/graph/EndpointPair;)Z
    ...
    invoke-virtual {p0, v0}, Lccsancom/google/common/graph/AbstractBaseGraph;->successors(Ljava/lang/Object;)Ljava/util/Set;
...
.method public inDegree(Ljava/lang/Object;)I
    ...
    :cond_0
    invoke-virtual {p0, p1}, Lccsancom/google/common/graph/AbstractBaseGraph;->degree(Ljava/lang/Object;)I
...
.method public incidentEdges(Ljava/lang/Object;)Ljava/util/Set;
    ...
    .line 104
    invoke-static {p0, p1}, Lccsancom/google/common/graph/AbstractBaseGraph$IncidentEdgeSet;->of(Lccsancom/google/common/graph/BaseGraph;Ljava/lang/Object;)Lccsancom/google/common/graph/AbstractBaseGraph$IncidentEdgeSet;
