.class final enum Lccsancom/google/common/hash/BloomFilterStrategies$2;
...
.method private lowerEight([B)J
    ...
    invoke-static/range {v1 .. v8}, Lccsancom/google/common/primitives/Longs;->fromBytes(BBBBBBBB)J
...
.method public mightContain(Ljava/lang/Object;Lccsancom/google/common/hash/Funnel;ILccsancom/google/common/hash/BloomFilterStrategies$LockFreeBitArray;)Z
    ...
    invoke-virtual/range {p4 .. p4}, Lccsancom/google/common/hash/BloomFilterStrategies$LockFreeBitArray;->bitSize()J
    ...
    invoke-interface {v3, v4, v5}, Lccsancom/google/common/hash/HashFunction;->hashObject(Ljava/lang/Object;Lccsancom/google/common/hash/Funnel;)Lccsancom/google/common/hash/HashCode;

    move-result-object v3

    invoke-virtual {v3}, Lccsancom/google/common/hash/HashCode;->getBytesInternal()[B

    move-result-object v3

    .line 117
    .local v3, "bytes":[B
    invoke-direct {v0, v3}, Lccsancom/google/common/hash/BloomFilterStrategies$2;->lowerEight([B)J

    move-result-wide v6

    .line 118
    .local v6, "hash1":J
    invoke-direct {v0, v3}, Lccsancom/google/common/hash/BloomFilterStrategies$2;->upperEight([B)J
    ...
    invoke-virtual {v0, v14, v15}, Lccsancom/google/common/hash/BloomFilterStrategies$LockFreeBitArray;->get(J)Z
...
.method public put(Ljava/lang/Object;Lccsancom/google/common/hash/Funnel;ILccsancom/google/common/hash/BloomFilterStrategies$LockFreeBitArray;)Z
    ...
    invoke-virtual {v15, v3, v4}, Lccsancom/google/common/hash/BloomFilterStrategies$LockFreeBitArray;->set(J)Z
