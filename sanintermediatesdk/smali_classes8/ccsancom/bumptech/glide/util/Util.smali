.class public final Lccsancom/bumptech/glide/util/Util;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lccsancom/bumptech/glide/util/Util;->HEX_CHAR_ARRAY:[C
    ...
    sput-object v0, Lccsancom/bumptech/glide/util/Util;->SHA_256_CHARS:[C
    ...
    sput-object v0, Lccsancom/bumptech/glide/util/Util;->SHA_1_CHARS:[C
...
.method private static bytesToHex([B[C)Ljava/lang/String;
    ...
    sget-object v3, Lccsancom/bumptech/glide/util/Util;->HEX_CHAR_ARRAY:[C
...
.method public static getBitmapByteSize(IILccsanandroid/graphics/Bitmap$Config;)I
    .locals 2
    .param p0, "width"    # I
    .param p1, "height"    # I
    ...
    invoke-static {p2}, Lccsancom/bumptech/glide/util/Util;->getBytesPerPixel(Lccsanandroid/graphics/Bitmap$Config;)I
...
.method public static getBitmapByteSize(Lccsanandroid/graphics/Bitmap;)I
    .locals 2
    ...
    invoke-virtual {p0}, Lccsanandroid/graphics/Bitmap;->getRowBytes()I
...
.method private static getBytesPerPixel(Lccsanandroid/graphics/Bitmap$Config;)I
    .locals 2
    .param p0, "config"    # Lccsanandroid/graphics/Bitmap$Config;
    ...
    .line 104
    :cond_0
    sget-object v0, Lccsancom/bumptech/glide/util/Util$1;->$SwitchMap$android$graphics$Bitmap$Config:[I
...
.method public static getSize(Lccsanandroid/graphics/Bitmap;)I
    .locals 1
    .param p0, "bitmap"    # Lccsanandroid/graphics/Bitmap;
...
.method public static isValidDimensions(II)Z
    ...
    .line 123
    invoke-static {p0}, Lccsancom/bumptech/glide/util/Util;->isValidDimension(I)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-static {p1}, Lccsancom/bumptech/glide/util/Util;->isValidDimension(I)Z
...
.method public static sha1BytesToHex([B)Ljava/lang/String;
    ...
    .line 43
    sget-object v0, Lccsancom/bumptech/glide/util/Util;->SHA_1_CHARS:[C

    monitor-enter v0

    .line 44
    :try_start_0
    invoke-static {p0, v0}, Lccsancom/bumptech/glide/util/Util;->bytesToHex([B[C)Ljava/lang/String;
...
.method public static sha256BytesToHex([B)Ljava/lang/String;
    ...
    .line 34
    sget-object v0, Lccsancom/bumptech/glide/util/Util;->SHA_256_CHARS:[C
