.class Lccsanandroidx/transition/ViewUtilsBase;
...
.method private fetchSetFrame()V
    ...
    .line 176
    sget-boolean v0, Lccsanandroidx/transition/ViewUtilsBase;->sSetFrameFetched:Z
    ...
    sput-object v1, Lccsanandroidx/transition/ViewUtilsBase;->sSetFrameMethod:Ljava/lang/reflect/Method;
    ...
    invoke-static {v2, v3, v1}, Lccsanandroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I

    .line 184
    .end local v1    # "e":Ljava/lang/NoSuchMethodException;
    :goto_0
    sput-boolean v0, Lccsanandroidx/transition/ViewUtilsBase;->sSetFrameFetched:Z
...
.method public clearNonTransitionAlpha(Lccsanandroid/view/View;)V
    ...
    .line 73
    sget v0, Lccsanandroidx/transition/R$id;->save_non_transition_alpha:I

    const/4 v1, 0x0

    invoke-virtual {p1, v0, v1}, Lccsanandroid/view/View;->setTag(ILjava/lang/Object;)V
...
.method public setAnimationMatrix(Lccsanandroid/view/View;Lccsanandroid/graphics/Matrix;)V
    ...
    invoke-virtual {p2}, Lccsanandroid/graphics/Matrix;->isIdentity()Z
    ...
    .line 118
    :cond_0
    iget-object v3, p0, Lccsanandroidx/transition/ViewUtilsBase;->mMatrixValues:[F
    ...
    iput-object v4, p0, Lccsanandroidx/transition/ViewUtilsBase;->mMatrixValues:[F

    .line 122
    :cond_1
    invoke-virtual {p2, v3}, Lccsanandroid/graphics/Matrix;->getValues([F)V
    ...
    .line 131
    .local v8, "dy":F
    invoke-virtual {p1, v2}, Lccsanandroid/view/View;->setPivotX(F)V

    .line 132
    invoke-virtual {p1, v2}, Lccsanandroid/view/View;->setPivotY(F)V

    .line 133
    invoke-virtual {p1, v1}, Lccsanandroid/view/View;->setTranslationX(F)V

    .line 134
    invoke-virtual {p1, v8}, Lccsanandroid/view/View;->setTranslationY(F)V

    .line 135
    invoke-virtual {p1, v6}, Lccsanandroid/view/View;->setRotation(F)V

    .line 136
    invoke-virtual {p1, v5}, Lccsanandroid/view/View;->setScaleX(F)V

    .line 137
    invoke-virtual {p1, v7}, Lccsanandroid/view/View;->setScaleY(F)V
    ...
    invoke-virtual {p1, v3}, Lccsanandroid/view/View;->setPivotX(F)V
    ...
    invoke-virtual {p1, v1}, Lccsanandroid/view/View;->setPivotY(F)V

    .line 112
    invoke-virtual {p1, v2}, Lccsanandroid/view/View;->setTranslationX(F)V

    .line 113
    invoke-virtual {p1, v2}, Lccsanandroid/view/View;->setTranslationY(F)V

    .line 114
    invoke-virtual {p1, v0}, Lccsanandroid/view/View;->setScaleX(F)V

    .line 115
    invoke-virtual {p1, v0}, Lccsanandroid/view/View;->setScaleY(F)V

    .line 116
    invoke-virtual {p1, v2}, Lccsanandroid/view/View;->setRotation(F)V
...
.method public setLeftTopRightBottom(Lccsanandroid/view/View;IIII)V
    ...
    .line 142
    invoke-direct {p0}, Lccsanandroidx/transition/ViewUtilsBase;->fetchSetFrame()V

    .line 143
    sget-object v0, Lccsanandroidx/transition/ViewUtilsBase;->sSetFrameMethod:Ljava/lang/reflect/Method;
...
.method public setTransitionVisibility(Lccsanandroid/view/View;I)V
    ...
    .line 155
    sget-boolean v0, Lccsanandroidx/transition/ViewUtilsBase;->sViewFlagsFieldFetched:Z
    ...
    sput-object v1, Lccsanandroidx/transition/ViewUtilsBase;->sViewFlagsField:Ljava/lang/reflect/Field;
    ...
    :goto_0
    sput-boolean v0, Lccsanandroidx/transition/ViewUtilsBase;->sViewFlagsFieldFetched:Z

    .line 164
    :cond_0
    sget-object v0, Lccsanandroidx/transition/ViewUtilsBase;->sViewFlagsField:Ljava/lang/reflect/Field;
    ...
    sget-object v1, Lccsanandroidx/transition/ViewUtilsBase;->sViewFlagsField:Ljava/lang/reflect/Field;
...
.method public transformMatrixToGlobal(Lccsanandroid/view/View;Lccsanandroid/graphics/Matrix;)V
    ...
    invoke-virtual {p0, v1, p2}, Lccsanandroidx/transition/ViewUtilsBase;->transformMatrixToGlobal(Lccsanandroid/view/View;Lccsanandroid/graphics/Matrix;)V
    ...
    .line 86
    .local v1, "vm":Lccsanandroid/graphics/Matrix;
...
.method public transformMatrixToLocal(Lccsanandroid/view/View;Lccsanandroid/graphics/Matrix;)V
    ...
    .line 95
    .local v1, "vp":Lccsanandroid/view/View;
    invoke-virtual {p0, v1, p2}, Lccsanandroidx/transition/ViewUtilsBase;->transformMatrixToLocal(Lccsanandroid/view/View;Lccsanandroid/graphics/Matrix;)V
    ...
    invoke-virtual {p2, v2, v3}, Lccsanandroid/graphics/Matrix;->postTranslate(FF)Z
    ...
    invoke-virtual {p2, v1, v2}, Lccsanandroid/graphics/Matrix;->postTranslate(FF)Z
    ...
    .line 102
    .local v2, "inverted":Lccsanandroid/graphics/Matrix;
    invoke-virtual {v1, v2}, Lccsanandroid/graphics/Matrix;->invert(Lccsanandroid/graphics/Matrix;)Z
    ...
    .line 103
    invoke-virtual {p2, v2}, Lccsanandroid/graphics/Matrix;->postConcat(Lccsanandroid/graphics/Matrix;)Z

    .line 106
    .end local v2    # "inverted":Lccsanandroid/graphics/Matrix;
    :cond_1
    return-void
.end method
