.class public Lccsancom/google/common/base/internal/Finalizer;
...
.method static constructor <clinit>()V
    ...
    .line 48
    const-class v0, Lccsancom/google/common/base/internal/Finalizer;
    ...
    sput-object v0, Lccsancom/google/common/base/internal/Finalizer;->logger:Ljava/util/logging/Logger;

    .line 120
    invoke-static {}, Lccsancom/google/common/base/internal/Finalizer;->getBigThreadConstructor()Ljava/lang/reflect/Constructor;

    move-result-object v0

    sput-object v0, Lccsancom/google/common/base/internal/Finalizer;->bigThreadConstructor:Ljava/lang/reflect/Constructor;

    .line 123
    if-nez v0, :cond_0

    .line 124
    invoke-static {}, Lccsancom/google/common/base/internal/Finalizer;->getInheritableThreadLocalsField()Ljava/lang/reflect/Field;
    ...
    :goto_0
    sput-object v0, Lccsancom/google/common/base/internal/Finalizer;->inheritableThreadLocals:Ljava/lang/reflect/Field;
...
.method private constructor <init>(Ljava/lang/Class;Ljava/lang/ref/ReferenceQueue;Ljava/lang/ref/PhantomReference;)V
    ...
    .line 131
    iput-object p2, p0, Lccsancom/google/common/base/internal/Finalizer;->queue:Ljava/lang/ref/ReferenceQueue;
    ...
    iput-object v0, p0, Lccsancom/google/common/base/internal/Finalizer;->finalizableReferenceClassReference:Ljava/lang/ref/WeakReference;

    .line 137
    iput-object p3, p0, Lccsancom/google/common/base/internal/Finalizer;->frqReference:Ljava/lang/ref/PhantomReference;
...
.method private cleanUp(Ljava/lang/ref/Reference;)Z
    ...
    invoke-direct {p0}, Lccsancom/google/common/base/internal/Finalizer;->getFinalizeReferentMethod()Ljava/lang/reflect/Method;
    ...
    .line 173
    iget-object v2, p0, Lccsancom/google/common/base/internal/Finalizer;->frqReference:Ljava/lang/ref/PhantomReference;
    ...
    sget-object v3, Lccsancom/google/common/base/internal/Finalizer;->logger:Ljava/util/logging/Logger;
    ...
    :goto_1
    iget-object v2, p0, Lccsancom/google/common/base/internal/Finalizer;->queue:Ljava/lang/ref/ReferenceQueue;
...
.method private getFinalizeReferentMethod()Ljava/lang/reflect/Method;
    ...
    .line 197
    iget-object v0, p0, Lccsancom/google/common/base/internal/Finalizer;->finalizableReferenceClassReference:Ljava/lang/ref/WeakReference;
...
.method private static getInheritableThreadLocalsField()Ljava/lang/reflect/Field;
    ...
    .line 221
    .local v0, "t":Ljava/lang/Throwable;
    sget-object v1, Lccsancom/google/common/base/internal/Finalizer;->logger:Ljava/util/logging/Logger;
...
.method public static startFinalizer(Ljava/lang/Class;Ljava/lang/ref/ReferenceQueue;Ljava/lang/ref/PhantomReference;)V
    ...
    .line 78
    new-instance v0, Lccsancom/google/common/base/internal/Finalizer;

    invoke-direct {v0, p0, p1, p2}, Lccsancom/google/common/base/internal/Finalizer;-><init>(Ljava/lang/Class;Ljava/lang/ref/ReferenceQueue;Ljava/lang/ref/PhantomReference;)V

    .line 79
    .local v0, "finalizer":Lccsancom/google/common/base/internal/Finalizer;
    const-class v1, Lccsancom/google/common/base/internal/Finalizer;
    ...
    sget-object v3, Lccsancom/google/common/base/internal/Finalizer;->bigThreadConstructor:Ljava/lang/reflect/Constructor;
    ...
    sget-object v6, Lccsancom/google/common/base/internal/Finalizer;->logger:Ljava/util/logging/Logger;
    ...
    .line 99
    :try_start_1
    sget-object v3, Lccsancom/google/common/base/internal/Finalizer;->inheritableThreadLocals:Ljava/lang/reflect/Field;
    ...
    sget-object v4, Lccsancom/google/common/base/internal/Finalizer;->logger:Ljava/util/logging/Logger;
    ...
    .line 75
    .end local v0    # "finalizer":Lccsancom/google/common/base/internal/Finalizer;
...
.method public run()V
    ...
    :goto_0
    :try_start_0
    iget-object v0, p0, Lccsancom/google/common/base/internal/Finalizer;->queue:Ljava/lang/ref/ReferenceQueue;

    invoke-virtual {v0}, Ljava/lang/ref/ReferenceQueue;->remove()Ljava/lang/ref/Reference;

    move-result-object v0

    invoke-direct {p0, v0}, Lccsancom/google/common/base/internal/Finalizer;->cleanUp(Ljava/lang/ref/Reference;)Z
