.class public final Lccsanandroidx/multidex/MultiDex;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lccsanandroidx/multidex/MultiDex$V4;,
        Lccsanandroidx/multidex/MultiDex$V14;,
        Lccsanandroidx/multidex/MultiDex$V19;
    }
.end annotation
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lccsanandroidx/multidex/MultiDex;->installedApk:Ljava/util/Set;
    ...
    invoke-static {v0}, Lccsanandroidx/multidex/MultiDex;->isVMMultidexCapable(Ljava/lang/String;)Z

    move-result v0

    sput-boolean v0, Lccsanandroidx/multidex/MultiDex;->IS_VM_MULTIDEX_CAPABLE:Z
...
.method static synthetic access$000(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/reflect/Field;
    ...
    .line 55
    invoke-static {p0, p1}, Lccsanandroidx/multidex/MultiDex;->findField(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/reflect/Field;
...
.method static synthetic access$100(Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    .line 55
    invoke-static {p0, p1, p2}, Lccsanandroidx/multidex/MultiDex;->expandFieldArray(Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method static synthetic access$200(Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/reflect/Method;
    ...
    .line 55
    invoke-static {p0, p1, p2}, Lccsanandroidx/multidex/MultiDex;->findMethod(Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/reflect/Method;
...
.method private static clearOldDexDir(Lccsanandroid/content/Context;)V
    .locals 9
    ...
    .line 442
    invoke-static {v3, v6}, Lccsanandroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-static {v3, v6}, Lccsanandroid/util/Log;->w(Ljava/lang/String;Ljava/lang/String;)I
...
.method private static doInstallation(Lccsanandroid/content/Context;Ljava/io/File;Ljava/io/File;Ljava/lang/String;Ljava/lang/String;Z)V
    .locals 9
    .param p0, "mainContext"    # Lccsanandroid/content/Context;
    ...
    .line 206
    sget-object v0, Lccsanandroidx/multidex/MultiDex;->installedApk:Ljava/util/Set;
    ...
    :cond_2
    :try_start_3
    invoke-static {p0}, Lccsanandroidx/multidex/MultiDex;->clearOldDexDir(Lccsanandroid/content/Context;)V
    :try_end_3
    ...
    :goto_0
    invoke-static {p0, p2, p3}, Lccsanandroidx/multidex/MultiDex;->getDexDir(Lccsanandroid/content/Context;Ljava/io/File;Ljava/lang/String;)Ljava/io/File;

    move-result-object v2

    .line 257
    .local v2, "dexDir":Ljava/io/File;
    new-instance v3, Lccsanandroidx/multidex/MultiDexExtractor;

    invoke-direct {v3, p1, v2}, Lccsanandroidx/multidex/MultiDexExtractor;-><init>(Ljava/io/File;Ljava/io/File;)V
    :try_end_4
    .catchall {:try_start_4 .. :try_end_4} :catchall_2

    .line 258
    .local v3, "extractor":Lccsanandroidx/multidex/MultiDexExtractor;
    const/4 v4, 0x0
    ...
    .line 261
    :try_start_5
    invoke-virtual {v3, p0, p4, v5}, Lccsanandroidx/multidex/MultiDexExtractor;->load(Lccsanandroid/content/Context;Ljava/lang/String;Z)Ljava/util/List;
    ...
    :try_start_6
    invoke-static {v1, v2, v5}, Lccsanandroidx/multidex/MultiDex;->installSecondaryDexes(Ljava/lang/ClassLoader;Ljava/io/File;Ljava/util/List;)V
    :try_end_6
    ...
    invoke-static {v7, v8, v6}, Lccsanandroid/util/Log;->w(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I

    .line 271
    const/4 v7, 0x1

    invoke-virtual {v3, p0, p4, v7}, Lccsanandroidx/multidex/MultiDexExtractor;->load(Lccsanandroid/content/Context;Ljava/lang/String;Z)Ljava/util/List;
    ...
    :goto_1
    :try_start_8
    invoke-virtual {v3}, Lccsanandroidx/multidex/MultiDexExtractor;->close()V
    :try_end_8
    ...
    .end local v3    # "extractor":Lccsanandroidx/multidex/MultiDexExtractor;
    ...
    .restart local v3    # "extractor":Lccsanandroidx/multidex/MultiDexExtractor;
    .restart local v4    # "closeException":Ljava/io/IOException;
    :cond_3
    nop

    .end local p0    # "mainContext":Lccsanandroid/content/Context;
    ...
    .restart local p0    # "mainContext":Lccsanandroid/content/Context;
...
.method private static getApplicationInfo(Lccsanandroid/content/Context;)Lccsanandroid/content/pm/ApplicationInfo;
    .locals 3
    .param p0, "context"    # Lccsanandroid/content/Context;
...
.method private static getDexDir(Lccsanandroid/content/Context;Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    .locals 5
    .param p0, "context"    # Lccsanandroid/content/Context;
    ...
    :try_start_0
    invoke-static {v0}, Lccsanandroidx/multidex/MultiDex;->mkdirChecked(Ljava/io/File;)V
    :try_end_0
    ...
    invoke-static {v1}, Lccsanandroidx/multidex/MultiDex;->mkdirChecked(Ljava/io/File;)V

    .line 473
    return-object v1
.end method

.method public static install(Lccsanandroid/content/Context;)V
    .locals 8
    .param p0, "context"    # Lccsanandroid/content/Context;
    ...
    .line 94
    sget-boolean v1, Lccsanandroidx/multidex/MultiDex;->IS_VM_MULTIDEX_CAPABLE:Z
    ...
    .line 105
    :try_start_0
    invoke-static {p0}, Lccsanandroidx/multidex/MultiDex;->getApplicationInfo(Lccsanandroid/content/Context;)Lccsanandroid/content/pm/ApplicationInfo;

    move-result-object v1

    .line 106
    .local v1, "applicationInfo":Lccsanandroid/content/pm/ApplicationInfo;
    if-nez v1, :cond_1

    .line 107
    const-string v2, "No ApplicationInfo available, i.e. running on a test Context: MultiDex support library is disabled."

    invoke-static {v0, v2}, Lccsanandroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I
    ...
    iget-object v2, v1, Lccsanandroid/content/pm/ApplicationInfo;->sourceDir:Ljava/lang/String;

    invoke-direct {v3, v2}, Ljava/io/File;-><init>(Ljava/lang/String;)V

    new-instance v4, Ljava/io/File;

    iget-object v2, v1, Lccsanandroid/content/pm/ApplicationInfo;->dataDir:Ljava/lang/String;
    ...
    invoke-static/range {v2 .. v7}, Lccsanandroidx/multidex/MultiDex;->doInstallation(Lccsanandroid/content/Context;Ljava/io/File;Ljava/io/File;Ljava/lang/String;Ljava/lang/String;Z)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0

    .line 122
    .end local v1    # "applicationInfo":Lccsanandroid/content/pm/ApplicationInfo;
    nop
...
.method public static installInstrumentation(Lccsanandroid/content/Context;Lccsanandroid/content/Context;)V
    .locals 16
    .param p0, "instrumentationContext"    # Lccsanandroid/content/Context;
    .param p1, "targetContext"    # Lccsanandroid/content/Context;
    ...
    .line 141
    sget-boolean v0, Lccsanandroidx/multidex/MultiDex;->IS_VM_MULTIDEX_CAPABLE:Z
    ...
    .line 152
    :try_start_0
    invoke-static/range {p0 .. p0}, Lccsanandroidx/multidex/MultiDex;->getApplicationInfo(Lccsanandroid/content/Context;)Lccsanandroid/content/pm/ApplicationInfo;

    move-result-object v0

    .line 153
    .local v0, "instrumentationInfo":Lccsanandroid/content/pm/ApplicationInfo;
    if-nez v0, :cond_1
    ...
    .line 159
    :cond_1
    invoke-static/range {p1 .. p1}, Lccsanandroidx/multidex/MultiDex;->getApplicationInfo(Lccsanandroid/content/Context;)Lccsanandroid/content/pm/ApplicationInfo;

    move-result-object v3

    .line 160
    .local v3, "applicationInfo":Lccsanandroid/content/pm/ApplicationInfo;
    if-nez v3, :cond_2
    ...
    iget-object v4, v3, Lccsanandroid/content/pm/ApplicationInfo;->dataDir:Ljava/lang/String;
    ...
    iget-object v4, v0, Lccsanandroid/content/pm/ApplicationInfo;->sourceDir:Ljava/lang/String;
    ...
    invoke-static/range {v4 .. v9}, Lccsanandroidx/multidex/MultiDex;->doInstallation(Lccsanandroid/content/Context;Ljava/io/File;Ljava/io/File;Ljava/lang/String;Ljava/lang/String;Z)V

    .line 177
    new-instance v11, Ljava/io/File;

    iget-object v4, v3, Lccsanandroid/content/pm/ApplicationInfo;->sourceDir:Ljava/lang/String;
    ...
    invoke-static/range {v10 .. v15}, Lccsanandroidx/multidex/MultiDex;->doInstallation(Lccsanandroid/content/Context;Ljava/io/File;Ljava/io/File;Ljava/lang/String;Ljava/lang/String;Z)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0

    .line 186
    .end local v0    # "instrumentationInfo":Lccsanandroid/content/pm/ApplicationInfo;
    .end local v2    # "instrumentationPrefix":Ljava/lang/String;
    .end local v3    # "applicationInfo":Lccsanandroid/content/pm/ApplicationInfo;
...
.method private static installSecondaryDexes(Ljava/lang/ClassLoader;Ljava/io/File;Ljava/util/List;)V
    ...
    .line 347
    invoke-static {p0, p2, p1}, Lccsanandroidx/multidex/MultiDex$V19;->install(Ljava/lang/ClassLoader;Ljava/util/List;Ljava/io/File;)V
    ...
    .line 349
    invoke-static {p0, p2}, Lccsanandroidx/multidex/MultiDex$V14;->install(Ljava/lang/ClassLoader;Ljava/util/List;)V

    goto :goto_0

    .line 351
    :cond_1
    invoke-static {p0, p2}, Lccsanandroidx/multidex/MultiDex$V4;->install(Ljava/lang/ClassLoader;Ljava/util/List;)V
