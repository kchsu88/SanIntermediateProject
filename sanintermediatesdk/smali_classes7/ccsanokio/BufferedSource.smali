.class public interface abstract Lccsanokio/BufferedSource;
...
# virtual methods
.method public abstract buffer()Lccsanokio/Buffer;
...
.method public abstract getBuffer()Lccsanokio/Buffer;
.end method
...
.method public abstract indexOf(Lccsanokio/ByteString;)J
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
...
.method public abstract indexOf(Lccsanokio/ByteString;J)J
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
...
.method public abstract indexOfElement(Lccsanokio/ByteString;)J
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
...
.method public abstract indexOfElement(Lccsanokio/ByteString;J)J
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
...
.method public abstract peek()Lccsanokio/BufferedSource;
.end method

.method public abstract rangeEquals(JLccsanokio/ByteString;)Z
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
...
.method public abstract rangeEquals(JLccsanokio/ByteString;II)Z
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
...
.method public abstract readAll(Lccsanokio/Sink;)J
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
...
.method public abstract readByteString()Lccsanokio/ByteString;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
...
.method public abstract readByteString(J)Lccsanokio/ByteString;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
...
.method public abstract readFully(Lccsanokio/Buffer;J)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
...
.method public abstract select(Lccsanokio/Options;)I
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
